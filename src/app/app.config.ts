...
export const appConfig: ApplicationConfig = {
  providers: [provideRouter(routes), provideClientHydration(), provideAnimations(), provideAnimations(), provideAnimations(), importProvidersFrom(provideFirebaseApp(() => initializeApp({"projectId":"kanbanfire-8c23c","appId":"1:49633413446:web:a100349a300d6307683d47","storageBucket":"kanbanfire-8c23c.appspot.com","apiKey":"AIzaSyC0FlMb0-U4HKxX2K4AsMhg0GzoD92naDo","authDomain":"kanbanfire-8c23c.firebaseapp.com","messagingSenderId":"49633413446"}))), importProvidersFrom(provideAuth(() => getAuth())), importProvidersFrom(provideAnalytics(() => getAnalytics())), ScreenTrackingService, UserTrackingService, importProvidersFrom(provideAppCheck(() => {
